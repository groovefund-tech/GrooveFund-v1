...
function TermsAccordion({ title, emoji, description, details, items }: { title: string; emoji: string; description: string; details?: string; items?: Array<{ key: string; value: string }> }) {
